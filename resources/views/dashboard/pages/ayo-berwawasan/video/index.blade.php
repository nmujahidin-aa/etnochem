...
<div class="container p-0">
    ...
    <div class="row mb-2">
        <div class="col-12">
            <a href="{{route('dashboard.video.create')}}" class="btn btn-primary">Create</a>
        </div>
    </div>
    <div class="row">
                    ...
                    <table class="table table-hover my-0" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$index+1}}</td>
                                <td>{{$row->title}}</td>
                                <td><a href="{{$row->video}}">Video {{$index+1}}</a></td>
                                <td>{{$row->description}}</td>
                                <td>
                                    <a href="{{route('dashboard.video.show',$row->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>
                                    <a href="{{route('dashboard.video.edit',$row->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
