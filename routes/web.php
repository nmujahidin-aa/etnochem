...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(["namespace" => "App\Http\Controllers\Dashboard", "as"=>"dashboard.", "prefix" => "dashboard", "middleware" => ['role:' . implode('|', [RoleEnum::ADMINISTRATOR, RoleEnum::STUDENT ])]], function () {
